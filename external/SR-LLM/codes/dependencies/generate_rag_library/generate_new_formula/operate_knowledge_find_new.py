...
port = "7890"
agent = RAG_AGENT(port=port, memory_path="../../../ragLibrary/memory_ngsim_find_new")
...
agent.knowledge_pool.add_knowledge(
    Knowledge(
        ...
        target=r'$factor_v_squared$: The symbol in dimensionless unit which represents the square of the speed influence factor',
        content=
